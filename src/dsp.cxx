                                  ...
                                  const LV2_Feature* const* features)
{
	...
	if (!map) {
		...
		printf("Fabla2: the host does not support Work:schedule, so Fabla2 \
	       cannot load samples without glitches! Please ask your host \
	       developers to implement Work:schedule!\n");
	}
...
int FablaLV2::atomBankPadLayer( const LV2_Atom_Object* obj, int& b, int& p,
                                int& l, float& v )
{
